  ...
  return <div className="page referral-page">
    ...
    <section className="panel link-panel">
      <div className="link-head">
        ...
        <div className="link-actions"><button onClick={share} disabled={!referralLink} aria-label="Share referral link"><Icon name="send" size={13}/><span>{shared?'✓':'↗'}</span>{shared?'Shared':'Share'}</button></div>
      </div>
