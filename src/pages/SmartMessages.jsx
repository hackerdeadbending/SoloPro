...
const empty={clientId:'',date:new {t('date')}().toISOString().slice(0,10),time:'',service:'',amount:'',note:'',meetingType:'client_place',meetingPlace:''};
...
function dateLabel(value,locale){return value?new Intl.{t('date')}{t('time')}Format(locale||'en-US',{weekday:'short',day:'numeric',month:'short'}).format(new {t('date')}(`${value}T12:00:00`)):'—'}
...
export default function SmartMessages(){
 ...
 const channelLabel={whatsapp:'WhatsApp',sms:'SMS',telegram:'Telegram',instagram:'Instagram',email:'Email',copy:'{t('copyMessage')}'}[selectedChannel]||'Send message';
