...
export function AppStateProvider({children}){
 ...
 const currentEmail=String(state.user.email||'').trim().toLowerCase();const grant=state.adminGrants?.[currentEmail];const grantActive=!!grant&&(!grant.expiresAt||new Date(grant.expiresAt)>new Date());const isAdmin=state.adminAccessEnabled&&currentEmail===ADMIN_EMAIL;const premiumActive=state.premium||grantActive||isAdmin;
